  ...
  <div class="admin-content">
    ...
    <div class="date-navigation">
      ...
      <div class="current-date">
        <div class="date-display">{{ $today->format('Y/m/d') }}</div>
        ...
        <tbody>
          @forelse($todayAttendances as $attendance)
            @php
              ...
              $clockIn = $attendance['start_time'] ? \Carbon\Carbon::parse($attendance['start_time'])->format('H:i') : '-';
              $clockOut = $attendance['end_time'] ? \Carbon\Carbon::parse($attendance['end_time'])->format('H:i') : '-';
...
function changeDate(direction) {
  const currentDate = new Date('{{ $today->format("Y-m-d") }}');
