...
@section('content')
  <div class="admin-attendance-detail-container">
    ...
    <div class="admin-content">
      ...
      <div class="attendance-detail-card">
        ...
        <div class="detail-section">
          <div class="section-content">
            ...
            <span
              class="section-value">{{ \Carbon\Carbon::parse($attendance->date)->format('Y年') }}{{ \Carbon\Carbon::parse($attendance->date)->format('m月d日') }}</span>
          </div>
        </div>
      ...
      <form action="{{ route('admin.modification-requests.approve', $attendance->id) }}" method="POST">
        @csrf
        @method('PUT')
